...
class ProjectorModule(nn.Module):
    ...
    def NoiseAddition(self,projCTF,projClean, Noise, multipleNoise=False):
        ...
        if self.args.AlgoType != 'generate':               
                ...
                self.sigmaNoiseGenerated=(self.snriteration*self.sigmaNoiseGenerated+sigma)/(self.snriteration+1)                               projNoisy= projCTF+self.sigmaNoiseGenerated*torch.exp(self.scalar[1])*Noise                   
